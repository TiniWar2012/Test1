            ...
            <View>
              ...
              <View style={styles.rowMenu}>
                ...
                >
                  <Image
                    style={styles.icon}
                    source={{ uri: "https://i.imgur.com/0GdOSVj.jpg" }}
                  />
                </TouchableOpacity>
                <TouchableOpacity
                  style={styles.loginBtn6}
                ...
                >
                  <Image
                    style={styles.icon}
                    source={{ uri: "https://i.imgur.com/knKhYGg.jpg" }}
                  />
                </TouchableOpacity>
                <TouchableOpacity
                  style={styles.loginBtn6}
                ...
                >
                  <Image
                    style={styles.icon}
                    source={{ uri: "https://i.imgur.com/325GNXi.jpg" }}
                  />
                </TouchableOpacity>
                <TouchableOpacity
                  style={styles.loginBtn6}
                ...
                >
                  <Image
                    style={styles.icon}
                    source={{ uri: "https://i.imgur.com/8WwwMi3.jpg" }}
                  />
                </TouchableOpacity>
              </View>
              ...
              <View style={styles.rowMenu}>
                ...
                >
                  <Image
                    style={styles.icon}
                    source={{ uri: "https://i.imgur.com/rq2QUpp.jpg" }}
                  />
                </TouchableOpacity>
                <TouchableOpacity
                  style={styles.loginBtn6}
                ...
                >
                  <Image
                    style={styles.icon}
                    source={{ uri: "https://i.imgur.com/UJDxAmS.jpg" }}
                  />
                </TouchableOpacity>
                <TouchableOpacity
                  style={styles.loginBtn6}
                ...
                >
                  <Image
                    style={styles.icon}
                    source={{ uri: "https://i.imgur.com/IXZqnOs.jpg" }}
                  />
                </TouchableOpacity>
                <TouchableOpacity
                  style={styles.loginBtn6}
                ...
                >
                  <Image
                    style={styles.icon}
                    source={{ uri: "https://i.imgur.com/UkidEIc.jpg" }}
                  />
                </TouchableOpacity>
              </View>
              ...
              <View style={styles.rowMenu}>
                ...
                >
                  <Image
                    style={styles.icon}
                    source={{ uri: "https://i.imgur.com/Yn9zlSd.jpg" }}
                  />
                </TouchableOpacity>
                <TouchableOpacity
                  style={styles.loginBtn6}
                ...
                >
                  <Image
                    style={styles.icon}
                    source={{ uri: "https://i.imgur.com/sQShUjP.jpg" }}
                  />
                </TouchableOpacity>
                <TouchableOpacity
                  style={styles.loginBtn6}
                ...
                >
                  <Image
                    style={styles.icon}
                    source={{ uri: "https://i.imgur.com/atXmKvG.jpg" }}
                  />
                </TouchableOpacity>
                <TouchableOpacity
                  style={styles.loginBtn6}
                ...
                >
                  <Image
                    style={styles.icon}
                    source={{ uri: "https://i.imgur.com/ph1LNdd.jpg" }}
                  />
                </TouchableOpacity>
              </View>
            </View>
