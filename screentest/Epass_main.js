      ...
      <SafeAreaView>
        <ScrollView style={styles.container}>
            <View style={styles.view1} >
                <Image style={styles.logoapp} source={{uri:'https://i.imgur.com/1bVQDfg.png'}} />
            </View>
            <View style={styles.info_user} >
                <View style={{flexDirection:'row', margin:20,}}>
                    <Image style={styles.logouser} source={{uri:'https://img.icons8.com/dotty/80/ef5c43/user-male-circle.png'}} />
                    <View style={{marginLeft:20}} >
                        <Text style={{color:'#A7A7A7',fontSize:16}}>Xin chào,</Text>
                        <Text style={{fontWeight:'bold',fontSize:23}}>đặng trần biên</Text>
                    </View>
                </View>
                <View style={styles.bottominfo}>
                    <View>
                        <Text style={{color:'#A7A7A7',fontSize:19}}>Số dư ví:</Text>
                        <View style={{flexDirection:'row'}}>
                            <Text style={{color:'#A7A7A7',fontSize:23,fontWeight:'bold'}}>* * * * * *</Text>
                            <AntDesign name="eye" color={'#9E9E9E'} size={25} style={{marginLeft:20}} />
                        </View>
                    </View>
